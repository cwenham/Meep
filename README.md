...
**Pre-Release**: Meep is built on DotNet Standard 2.1 with a Core 3.0 executable.
It's at 1.0.0-alpha now, and I'll make a formal release once DotNet 3.0 is out of
preview.
