...
namespace MeepLib.Algorithms
{
    ...
    /// <remarks>Taken from https://gist.github.com/richardkundl/8300092
    /// </remarks>
    public class BloomFilter<T>
    {
        ...
        /// <summary>
        /// Creates a new Bloom filter per BloomFilter(capacity) and loads an
        /// existing bit array
        /// </summary>
        /// <param name="capacity">Capacity.</param>
        /// <param name="bits">Bits.</param>
        /// <remarks>Added to /richardkundl's version for Meep.</remarks>
        public BloomFilter(int capacity, HashFunction hashFunction, BitArray bits)
            : this(capacity, hashFunction)
        {
            _hashBits = bits;
        }
